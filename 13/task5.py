...
# ● Возраст — это положительное целое число, не меньше 0 и не больше120.
# Создайте пользовательские исключения для каждой из этих проверок:
# ● NameError: Если имя не соответствует
...
class AgeError(Exception):
    def __init__(self, age):
        super().__init__('должно быть положительное целое число, не меньше 0 и не больше 120.')
...
try:
    user = User(name="John Wood", email="john.wood@example.com", age=40)
